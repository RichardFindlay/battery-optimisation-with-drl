...
var svg = d3.select("#vis")
    ...
    // .attr("viewBox", [-20, -10, width + 40, 100])
...
// button = d3.select("#my_dataviz100")
//     .append("button")
//     .attr("id", "play-button")
//     .attr("class", "button")
//     .text("Simulate ⚡")
...
// var svg_2 = d3.select("#button_div")
//     .append("svg")
//     .attr("width", width - 50)
//     .attr("height", 10)  


// button_ele = d3.select("#button_div").append("g")
//     .append("button")
//     .attr("id", "play-button")
//     .text("Simulate ⚡")
    // .attr("id", "play-button")
...
// add x-axis time markers - minor ticks (hours)
// svg.selectAll("line.veticalGrid").data(x_input.ticks(168)).enter()
//     .append("line")
//         .attr("class", "verticalGrid")
//         .attr("y1", 0)
//         .attr("y2", 5)
//         .attr("x1", function(d){ return x_input(d);})
//         .attr("x2", function(d){ return x_input(d);})
//         .attr("fill", "none")
//         .attr("shape-rendering", "crispEdges")
//         .attr("stroke", "#BEBEBE")
//         .attr("stroke-width", "1px")
//         .attr("opacity", 0.5)
//         .attr("transform", "translate(" + 20 + "," + 25.5 + ")")


// add x-axis time markers - minor ticks (noon)
// svg.selectAll("line.veticalGrid_days").data(x_input.ticks(24)).enter()
//     .append("line")
//         .attr("class", "verticalGrid_days")
//         .attr("y1", 0)
//         .attr("y2", 10)
//         .attr("x1", function(d){ return x_input(d);})
//         .attr("x2", function(d){ return x_input(d);})
...
//         .attr("opacity", 1.0)
//         .attr("transform", "translate(" + 20 + "," + 23.5 + ")")


// add x-axis time markers - minor ticks (hours)
// svg.selectAll("line.veticalGrid_days").data(x_input.ticks(7)).enter()
//     .append("line")
//         .attr("class", "verticalGrid_days")
//         .attr("y1", 0)
//         .attr("y2", 11.5)
//         .attr("x1", function(d){ return x_input(d)+20;})
//         .attr("x2", function(d){ return x_input(d)+20;})
//         .attr("fill", "none")
//         .attr("shape-rendering", "crispEdges")
//         .attr("stroke", "#BEBEBE")
//         .attr("stroke-width", "1.5px")
...
// soc_Yaxis.selectAll('.tick text').each(function(_,i){
//   if(i%2==0){
//     d3.select(this).remove()
//   }
// })
...
// Add Y axis
// act_Yaxis = svg_100.append("g")
//   .attr("class", "y axis_act")
//   .call(yAxis_bar_soc)
//   .select(".domain").remove();
...
// var ticks_1 = d3.select('#my_dataviz100').selectAll(".tick text");

// ticks_1.each(function(_,i){
//     if(i%2 == 0) { d3.select(this).remove();
// }});


// ticks_1 = d3.select('#my_dataviz100').selectAll(".tick text")
...
// d3.select('#my_dataviz100').selectAll(".tick text").remove()


// d3.select("x.axis_dates").selectAll('.tick text').each(function(_,i){
//     if(i%2==1){
//       d3.select(this).remove()
//     }
//   })
