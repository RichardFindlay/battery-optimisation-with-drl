...
class LSTMCNNModel(nn.Module):
	def __init__(self):
		...
		self.cnn = nn.Conv1d(6, 24, kernel_size=24, stride=24)
		self.lstm = nn.LSTM(14, 32, 6, batch_first=True)
...
def main():
	...
	train_set_load = open("./Data/processed_data/train_data_336hr_in_24hr_out.pkl", "rb") 
